...
export class HomeComponent implements OnInit {
  ...
  saveAnimal(): void{
    ...
    this.animalService.save(this.animal).subscribe(res => {
      ...
      let msg = err.error && err.error.message ? err.error.message : 'Error al agregar animal, intente más tarde' 
      this.btnLoad = false
  ...
  deleteAnimal(a: any): void{
    ...
    this.animalService.delete(a._id).subscribe(res => {
      ...
      let msg = err.error && err.error.message ? err.error.message : 'Error al eliminar animal, intente más tarde' 
      this.btnLoad = false
      Swal.fire({icon: 'error', title: msg})
    })
  }
